...
class QuestionController extends GetxController
  ...
  void resetQuiz() {
    ...
    // Restablece el controlador de animación y otras variables de estado si es necesario
    _animationController.reset();

    // Reinicializa el controlador de página
    _pageController = PageController();

    // Llama a update para refrescar la UI
    update();
  }
